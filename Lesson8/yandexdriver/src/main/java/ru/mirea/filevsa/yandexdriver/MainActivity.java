...
import ru.mirea.filevsa.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener,
        UserLocationObjectListener {
    private static final int REQUEST_CODE_PERMISSION = 100;
    private ActivityMainBinding binding;
    private final Point ROUTE_START_LOCATION = new Point(55.660450, 37.474883);
    private final Point ROUTE_END_LOCATION = new Point(55.817827, 37.440365);
        ...
        if(isWork) {
            ...
            marker.addTapListener(new MapObjectTapListener() {
                ...
                public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point point) {
                    Toast.makeText(MainActivity.this, "Арена Спартака", Toast.LENGTH_SHORT).show();
                    return false;
                }
            });
        } else {
    ...
    private void submitRequest(Point userLoc) {
