...
import ru.mirea.filevsa.mireaproject.databinding.ActivityCafeBinding;

public class CafeActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {
    ...
    private final Point USER_LOC = new Point(55.660450, 37.474883);
    ...
    private void addHomeMarker() {
        ...
        homeTapListener = (mapObject, point) -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(CafeActivity.this)
                    .setTitle("Общежитие №1 РТУ МИРЭА")
                    .setMessage("проспект Вернадского, 86с1")
