package ru.mirea.filevsa.httpurlconnection;
    ...
    private class DownloadPageTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                String hostname = responseJson.optString("hostname");
                binding.hostnameTextView.setText("Hostname: " + hostname);

                String org = responseJson.optString("org");
                binding.orgTextView.setText("ORG: " + org);

                String postal = responseJson.optString("postal");
                binding.postalTextView.setText("Postal: " + postal);

                String timezone = responseJson.optString("timezone");
                binding.timezoneTextView.setText("Timezone: " + timezone);

                String loc = responseJson.getString("loc");
                binding.locTextView.setText("LOC: " + loc);
