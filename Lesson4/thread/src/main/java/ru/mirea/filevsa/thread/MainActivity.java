package ru.mirea.filevsa.thread;
...
import ru.mirea.filevsa.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: БСБО-10-21, НОМЕР ПО СПИСКУ: 27, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Собачья жизнь");
